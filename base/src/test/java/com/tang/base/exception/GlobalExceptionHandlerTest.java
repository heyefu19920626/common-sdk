...
class GlobalExceptionHandlerTest {
    ...
    void should_return_error_2_when_use_custom_define_handle() {
        Response<?> response = globalExceptionHandler.handleThrowable(new TestException(TestErrorCode.TEST_ERROR_CODE));
    ...
    void should_return_error_when_use_default_handle() {
        Response<?> response = globalExceptionHandler.handleThrowable(new BaseException(TestErrorCode.TEST_ERROR_CODE));
